export default function ContentCardComp({heading,content,img}:{heading:string,content:string,img:string}){
    return(
        <div className="bg-white border border-slate-100 min-w-20 shadow-sm rounded-md p-2 md:p-2 lg:p-4 flex flex-col gap-4 lg:gap-6 w-20 sm:w-30 md:w-42 lg:w-60 hover:shadow-md text-sm transform transition-all duration-200 ease-out
            hover:-translate-y-2">
